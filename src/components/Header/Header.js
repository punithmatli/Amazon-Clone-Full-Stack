        ...
        <div className="header">
            ...
            <div className="header__nav">
                ...
                <Link to="/checkout">
                        ...
                        <span className="header__basketCount header__option__lineTwo">{basket.length}</span>
                </Link>
                    </div>
            </div>
        </div>
